...
EFFECT(ADD_FAULT,					false,	NULL,		0,		EFINFO_NONE,	"makes an item faulty", "repair fault")
...
EFFECT(RECALL,						false,	NULL,		1,		EFINFO_DICE,	"returns you from the dungeon or takes you to the dungeon after %s turns",	"recall")
EFFECT(DEEP_DESCENT,				false,	NULL,		1,		EFINFO_SUB,		"teleports you up to %s dungeon levels lower than the lowest point you have reached so far", "descend to the depths")
