...
EFFECT(DETECT_GOLD,					false,	NULL,		0,		EFINFO_NONE,	"detects cash nearby")
...
EFFECT(DISENCHANT,					false,	NULL,		0,		EFINFO_NONE,	"drains one of your wielded items")
EFFECT(ENCHANT,						false,	NULL,		0,		EFINFO_NONE,	"attempts to enhance an item")
...
EFFECT(LIGHT_LEVEL,					false,	NULL,		0,		EFINFO_NONE,	"completely lights up and maps the level")
EFFECT(DARKEN_LEVEL,				false,	NULL,		0,		EFINFO_NONE,	"completely darkens and maps the level")
