 ...
 * and "data" directories (for example, those could be "/etc/xygos/",
 * "/usr/share/xygos", and "/var/games/xygos").  Some system-dependent
 * expansion/substitution may be done when copying those base paths to the
 * paths Xygos uses:  see path_process() in z-file.c for details (Unix
