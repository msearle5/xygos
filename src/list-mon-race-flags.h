...
RF(DROP_RANDOM,	RFT_BEHAV,		"")
RF(AQUATIC,		RFT_BEHAV,		"")
RF(CONFUSED,	RFT_BEHAV,		"")
RF(MIMIC_INV,	RFT_BEHAV,		"")
RF(STUPID,		RFT_BEHAV,		"")
RF(SMART,		RFT_BEHAV,		"")
RF(PREFER_MELEE,RFT_BEHAV,		"")
RF(SPIRIT,		RFT_BEHAV,		"")
RF(POWERFUL,	RFT_BEHAV,		"")
RF(FLYING,		RFT_BEHAV,		"")
RF(ALL_TERRAIN,	RFT_BEHAV,		"")
RF(EVASIVE,		RFT_BEHAV,		"")
RF(TAKE_NEAR,	RFT_BEHAV,		"")
RF(ORTHOGONAL,	RFT_BEHAV,		"")
RF(FRIENDLY,	RFT_BEHAV,		"")
RF(NEUTRAL,		RFT_BEHAV,		"")
...
RF(PASS_DOOR,	RFT_ALTER,		"pass under doors")
...
RF(IM_INERTIA,	RFT_RES,		"inertia")
RF(REFLECT,		RFT_RES,		"projectiles")
RF(IM_EDGED,	RFT_RES,		"edged weapons")
RF(IM_BLUNT,	RFT_RES,		"blunt weapons")
