...
void get_debug_command(void)
{
	...
	switch (cmd)
	{
		...
		case 'd':
		{
			effect_simple(EF_DETECT_TRAPS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_DOORS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_STAIRS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_GOLD, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_OBJECTS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_VISIBLE_MONSTERS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			effect_simple(EF_DETECT_INVISIBLE_MONSTERS, source_player(), "0", 0, 0, 0, 255, 255, NULL);
			break;
		}
