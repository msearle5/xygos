...
static void project_object_handler_MON_LAG(project_object_handler_context_t *context)
{
}
...
static void project_object_handler_MON_PAINT(project_object_handler_context_t *context)
{
}
