...
RSF(STING,		RST_BOLT | RST_INNATE)
RSF(SLING,		RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(ARROW,		RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(BOLT,		RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(SPIKE,		RST_BOLT | RST_INNATE | RST_ARCHERY)
...
RSF(BA3_FIRE,	RST_BALL)
RSF(BA_COLD,	RST_BALL)
RSF(BA_POIS,	RST_BALL)
RSF(BA8_POIS,	RST_BALL)
RSF(BA_SHAR,	RST_BALL)
RSF(BA_RADI,	RST_BALL)
RSF(BA_WATE,	RST_BALL)
RSF(BA_PLAS,	RST_BALL)
RSF(BA_TIME,	RST_BALL)
RSF(BA_GRAV,	RST_BALL)
RSF(BA_INER,	RST_BALL)
...
RSF(HALLU,		RST_HEAL)
RSF(FLAMES,		RST_HEAL)
RSF(FLAMES3,	RST_HEAL)
RSF(MINE_EXPLODE,	RST_HEAL)
RSF(SELF_DESTRUCT,	RST_HEAL)
RSF(HEAL_KIN,	RST_HEAL_OTHER)
RSF(HOP,		RST_TACTIC | RST_ESCAPE)
...
RSF(GROW,		RST_TACTIC)
RSF(S_FRIENDS,	RST_SUMMON)
RSF(S_KIN,		RST_SUMMON)
RSF(S_HI_DEMON,	RST_SUMMON)
RSF(S_ROBOT,	RST_SUMMON)
...
RSF(MULTIPLY_GROW,	RST_ANNOY | RST_INNATE)
RSF(TOADSTOOL,	RST_ANNOY | RST_INNATE)
RSF(MAX,		0)
