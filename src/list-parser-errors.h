...
PARSE_ERROR(INVALID_SPELL_FREQ,		"invalid technique frequency")
PARSE_ERROR(INVALID_SPELL_NAME,		"invalid technique name")
PARSE_ERROR(INVALID_SPELL_STAT,		"invalid technique stat")
